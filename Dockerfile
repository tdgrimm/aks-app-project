...
RUN dotnet build WORKDIR -c Release -o /app/build

FROM build AS publish
#RUN dotnet publish "Shopping/Shopping.Client/Shopping.Client.csproj" -c Release -o /app/publish /p:UseAppHost=false
RUN dotnet publish WORKDIR -c Release -o /app/publish /p:UseAppHost=false
